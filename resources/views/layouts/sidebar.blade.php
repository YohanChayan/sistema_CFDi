<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        {{-- Logotipo --}}
        <a href="{{ (Auth::Check()) ? route('dashboard') : route('home') }}" class="navbar-brand mx-4 mb-3">
        ...
        <div class="navbar-nav w-100">
            <a href="{{ (Auth::Check()) ? route('dashboard') : route('home') }}" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Inicio</a>
